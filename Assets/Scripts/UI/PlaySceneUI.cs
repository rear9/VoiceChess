...
/// <summary>
/// shows partial (live) transcript while Whisper is inferring, final transcript shown in bold after inference
/// move history: white left column, black right column, correct SAN notation, recording dot pulses while mic is active
/// </summary>
...
public class PlaySceneUI : MonoBehaviour
{
    ...
    private void OnCheckmate(PieceColor _) => checkLabel?.gameObject.SetActive(false);
    private void OnStalemate() => checkLabel?.gameObject.SetActive(false);
